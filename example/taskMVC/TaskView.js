    ...
    buildList: function () {
        ...
        for (var task in tasks) {
            ...
            if (tasks[task].taskStatus == 'completed') {
                html = " style=\"color:green;text-decoration:line-through;\"";
            }else{
              html= "";
            }

            $tasksContainer.append("<label"+html+"><input type=\"checkbox\" class=\"js-task\" data-index=\"" + index + "\" data-task-selected=\"false\">" + tasks[task].taskName + "</label>");
